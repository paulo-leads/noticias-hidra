...
const items = pages.map((p) => {
  ...
  const nivel_impacto = getProp(props, ["nivel_impacto", "Nível Impacto", "Nivel Impacto"])?.select?.name || plainTextFromRichText(getProp(props, ["nivel_impacto", "Nível Impacto", "Nivel Impacto"]));
